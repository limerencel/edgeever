...
[在 GitHub Fork EdgeEver](https://github.com/tianma-if/edgeever/fork)，然后查看[在线部署文档](docs/deploy-cloudflare-button.zh-CN.md)。

### 方案二：AI Agent 部署
将下方提示词复制给已接入 GitHub 和 Cloudflare 的 AI Agent：
